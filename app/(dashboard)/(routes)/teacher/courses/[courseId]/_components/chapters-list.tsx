                        ...
                        {chapters.map((chapter, index) => (
                            ...
                            >
                                {(provided) => (
                                    <div
                                    className={cn(
                                        "flex items-center gap-x-2 bg-slate-200 border-slate-200 border slate-700 rounded-md mb-4 text-sm",
                                    ...
                                    >
                                        ...
                                        <div className="ml-auto pr-2 flex items-center gap-x-2">
                                            ...
                                            className="w-4 h-4 cursoe-pointer hover:opacity-75 transition"
                                            />
                                        </div>
                                    </div>
                                )}
